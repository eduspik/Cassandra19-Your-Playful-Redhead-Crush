  ...
  return (
    <div className={`flex items-end ${isModel ? 'justify-start' : 'justify-end'}`}>
      <div
        ...
        } ${message.imageUrl && !message.content ? 'p-2 bg-gray-700' : 'px-4 py-3'}`}
      >
        ...
        {message.imageUrl && message.imageUrl !== 'loading' && (
            <a href={message.imageUrl} target="_blank" rel="noopener noreferrer" title="View full image">
                <img src={message.imageUrl} alt="Generated by Cassandra" className="rounded-lg max-w-xs w-full" />
            </a>
        )}
        {message.content && (
